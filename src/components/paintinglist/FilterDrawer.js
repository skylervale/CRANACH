    ...
    >
        ...
        <Container aligncontent={"center"}>
            <Typography id="range-slider" align="center">
                Jahresbereich <br/> {filter.yearRange}
            </Typography>
                <Slider
        ...
        <FormControl className={classes.formControl} fullWidth={false}>
            <InputLabel id="demo-mutiple-checkbox-label">Einstufung</InputLabel>
            <Select
                name="classification"
        ...
        <FormControl className={classes.formControl}>
            <InputLabel id="demo-mutiple-checkbox-label">Mittel</InputLabel>
            <Select
                name="mediumValues"
                labelId="demo-mutiple-checkbox-label"
                id="demo-mutiple-checkbox"
        ...
        <FormControl className={classes.formControl}>
            <InputLabel id="demo-mutiple-checkbox-label">Besitzer</InputLabel>
            <Select
                name="owners"
                labelId="demo-mutiple-checkbox-label"
                id="demo-mutiple-checkbox"
        ...
        <FormControl className={classes.formControl}>
            <InputLabel id="demo-mutiple-checkbox-label">Standorte</InputLabel>
            <Select
                name="locations"
                labelId="demo-mutiple-checkbox-label"
                id="demo-mutiple-checkbox"
        ...
        <FormControl className={classes.formControl}>
            <InputLabel id="demo-mutiple-checkbox-label">Repositorien</InputLabel>
            <Select
                name="repositories"
                labelId="demo-mutiple-checkbox-label"
                id="demo-mutiple-checkbox"
